...
export default function EmailVorlageDetailPage() {
  ...
  if (error && !title) {
    return (
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <Link href="/kommunikation/email-vorlagen" className="text-sm text-[#FF6554] hover:underline">
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <section className="content-radius border border-zinc-200 bg-white p-6">
        <label className="block text-sm font-semibold text-zinc-700">Titel</label>
        <input
          type="text"
          value={title}
        ...
        />
        <label className="mt-4 block text-sm font-semibold text-zinc-700">Betreff</label>
        <input
          type="text"
          value={subject}
          ...
          className="mt-1 w-full rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-900"
        />
        <h2 className="mt-6 text-sm font-semibold text-zinc-700">Inhalt</h2>
        <div className="mt-3">
          <textarea
            rows={12}
            value={body}
      ...
      <div className="flex gap-3">
        <Link
          href="/kommunikation/email-vorlagen"
